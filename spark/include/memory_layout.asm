...
stack_top_flat = (stack_segment shl 0x4) + stack_top
...
supervisor_bounce_buffer_offset = 0x2000
supervisor_bounce_buffer_segment = 0x1000
supervisor_bounce_buffer_flat = (supervisor_bounce_buffer_segment shl 0x4) + supervisor_bounce_buffer_offset
